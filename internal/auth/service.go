...
func (s *Service) Register(ctx context.Context, req *RegisterRequest, reqCtx *RequestContext) (*AuthResponse, error) {
	// Validate input
	...
	return s.createSessionAndTokens(ctx, newUser, reqCtx)
}
