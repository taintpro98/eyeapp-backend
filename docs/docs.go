...
const docTemplate = `{
        ...
        "/api/v1/orders": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Filter by asset symbol (e.g. ETHUSDT)",
                        "name": "symbol",
                        "in": "query"
                    },
                    {
                    ...
                    {
                        "type": "string",
                        "description": "Filter by order type (e.g. market, limit)",
                        "name": "order_type",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Start of time range GMT+7 (YYYY-MM-DD HH:MM:SS)",
                        "name": "from",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "End of time range GMT+7 (YYYY-MM-DD HH:MM:SS)",
                        "name": "to",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/orders.listResponse"
                        }
                    },
                    "400": {
    ...
    "definitions": {
        "apierrors.ErrorBody": {
            ...
            "properties": {
                "code": {
                    "allOf": [
                        {
                            "$ref": "#/definitions/apierrors.ErrorCode"
                        }
                    ],
        ...
        "apierrors.ErrorResponse": {
            ...
            "properties": {
                "error": {
                    "$ref": "#/definitions/apierrors.ErrorBody"
                }
            }
        },
        "auth.AuthResponse": {
        ...
        "orders.listResponse": {
            ...
            "properties": {
                ...
                "pagination": {
                    "$ref": "#/definitions/orders.paginationResponse"
                }
            }
        },
